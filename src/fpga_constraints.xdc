...
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { d_inA }]; 
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { s_inA }]; 
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { d_inB }]; 
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { s_inB }]; 
